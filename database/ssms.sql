CREATE DATABASE  IF NOT EXISTS `db_ssms` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
USE `db_ssms`;
...
--
-- Table structure for table `dbo_delivery_infor`
--

DROP TABLE IF EXISTS `dbo_delivery_infor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dbo_delivery_infor` (
  `delivery_infor_id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `address` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `phone_number` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `user_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`delivery_infor_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `dbo_order` (
  ...
  `created_date` datetime DEFAULT NULL,
  `delivery_infor_id` int(11) DEFAULT NULL,
...
CREATE TABLE `dbo_product` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `short_desc` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `main_imgae` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `price` decimal(10,2) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
...
--
-- Table structure for table `dbo_product_color`
--

DROP TABLE IF EXISTS `dbo_product_color`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dbo_product_color` (
...
--
-- Table structure for table `dbo_product_size`
--

DROP TABLE IF EXISTS `dbo_product_size`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `dbo_product_size` (
...
-- Dump completed on 2019-03-17 23:21:17
